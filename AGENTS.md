...
### Wiki健全性パイプライン（17:00 UTC / 翌02:00 JST）

```
wiki-health (17:00) ──→ wiki-health-plan (17:10) ──→ wiki-health-fix (17:25) ──→ wiki-watchdog-fix (17:35)
                          ↑ script: wiki_health.py       ↑ script: wiki_health_plan_checkpoint.py
```
...
| `wiki_health.py` | Wiki健全性スキャン | wiki-health |
