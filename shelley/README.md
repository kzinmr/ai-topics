# shelley/ — Shelley 作業領域

Hermes Agent の運用基盤に関する **Shelley (exe.dev コーディングエージェント)** の調査・検討・設計ドキュメントを管理するディレクトリ。

## 目的

Hermes の運用改善 (o11y、インフラ、ツール選定など) について kzinmr が Shelley に相談・調査・設定作業を依頼するメタ作業の成果物置き場。wiki/ や hermes/ はHermesが管理する知識資産であり、この領域はそれとは別の「運用者側の作業ノート」に相当する。
