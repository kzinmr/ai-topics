...
- **Images**: **GPT Image 1**, **GPT Image 1 mini**, and **GPT Image 1.5** made native image generation a practical default. Image generation as a tool in the [[concepts/gpt/responses-api]] enabled creation within multi-turn conversations.
...
- The [[concepts/gpt/responses-api]] (`/v1/responses`) launched as the successor to Chat Completions and the Assistants API, supporting multiple inputs/outputs, reasoning controls, and better tool calling.
- The open-source **[[concepts/gpt/agents-sdk]]** (Python and TypeScript) and **AgentKit** provided higher-level building blocks for orchestrating agents.
...
- [[concepts/gpt/responses-api]] — Agent-native API launched in 2025
- [[concepts/gpt/agents-sdk]] — Open-source agent framework released in 2025
