...
- [[concepts/accelerate]] — Accelerate — HuggingFace library for distributed training. Enables mixed precision, gradient accumulation, and multi-GPU/TPU training with minimal code changes.
