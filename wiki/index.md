...
- [[concepts/rpg-regularized-policy-gradient]] — RPG (Regularized Policy Gradient) — Post-training RL technique using KL-regularized policy gradients for stable and effective LLM alignment and reasoning improvement.
...
- [[concepts/training-free-rl]] — Training-Free RL — Achieving RL alignment effects without weight updates via inference-time sampling. ETS (Energy-Guided TTS), Power Sampling (MCMC), self-evolving approaches. Fundamental limits: Ω(√H) VB>VF gap, model collapse ceiling for intrinsic rewards.
...
- [[raw/articles/2026-04-09_sheriyuo_test-time-scaling-training-free-rl]] — Xiuyu Li: Test-Time Scaling and Training-Free RL. TTS taxonomy, MCMC/Power Sampling, ETS (Energy-Guided TTS) proposal. ETS outperforms GRPO on reasoning/math/code. Paper: arxiv 2601.21484. Companion: [[concepts/training-free-rl]], [[concepts/test-time-scaling]]
- [[raw/articles/2026-06-01_sheriyuo_rl-for-test-time-scaling]] — Xiuyu Li: RL for Test-Time Scaling. Why training-free is suboptimal (ICML'25 Ω(√H)), MRT, e3, InT, Privileged Exploration, TTI. Industry view (gpt-oss 120b), future: Continual Learning, OPD. Companion: [[concepts/training-free-rl]], [[concepts/test-time-scaling]], [[concepts/test-time-interaction-scaling]]
