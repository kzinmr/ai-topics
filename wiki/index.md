...
- [[concepts/agent-memory-systems-comparison]] — Agent Memory Systems Comparison — OpenClaw/Claude Code/Codex/Hermes 4ハーネスのメモリアーキテクチャ比較。ファイルファースト共通哲学、ベクトル検索vs全文検索、非同期vs同期vs Bounded Snapshot、Pre-Compaction Flush、Bustamante 3タイプ分類、選択ガイド付き。
