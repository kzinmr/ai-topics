...
- [[concepts/build-the-thing-meta-development]] — Build the Thing That Builds the Thing — Meta-development pattern: build automation tools that enhance agent-driven development itself. Frustration → tool → compound cycle. Close Reaper, Octopus, Crab Box, Auto Review, Core Patch, Crab Fleet. "Slop is fine."
...
- [[raw/articles/2026-06-02_microsoft-build_brk245-build-the-thing]] — Build the Thing That Builds the Thing — Microsoft Build 2025 BRK245. Peter Steinberger on the meta-development philosophy behind OpenClaw's automation ecosystem: Close Reaper, Octopus, Crab Box, Auto Review, Core Patch, Crab Fleet.
