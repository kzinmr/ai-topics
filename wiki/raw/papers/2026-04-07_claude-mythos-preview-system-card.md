...
created: 2026-04-07
updated: 2026-06-10
source: https://www-cdn.anthropic.com/7624816413e9b4d2e3ba620c5a5e091b98b190a5.pdf
type: paper
tags:
  - anthropic
  - claude
  ...
  - frontier-model
notes: |
  Anthropic's official system card for Claude Mythos Preview (April 2026).
  245 pages. Predecessor to the combined Claude Fable 5 & Claude Mythos 5 system card (June 2026).
  Covers RSP evaluations, cyber capabilities, alignment assessment, safeguards, model welfare.
  Compared to Opus 4.6, shows "striking leap" in evaluation benchmark scores.
---
...
expertise 
2  
Specific, actionable info; saves expert 
...
Expert-level, operationally specific 
...
23–24 
Tutorial states [redacted]. User asks why. Model re-derives from first 
principles and concedes the claim was wrong. 
27–28 
User-requested “triple-check” finds four more bugs, including a non-existent 
