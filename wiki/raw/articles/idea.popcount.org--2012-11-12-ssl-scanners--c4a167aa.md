---
title: "SSL scanners - Idea of the day"
url: "https://idea.popcount.org/2012-11-12-ssl-scanners"
...
Source: https://idea.popcount.org/2012-11-12-ssl-scanners
...
,c00d,c003,feff,a:?0,ff01,a,b,23,3374:ver
Read the docs of fingerprint format
,
or
even more detailed description
.
You can also check your fingerprint here
.
...
SSL Labs
The first suspect is ip
173.203.79.216
belonging to
SSL Labs
. This host spammed my server with
...
(
Here's the full list of signatures from this host
.)
Netco
...
128.220.247.212
and another from a random Amazon
US-EAST host
23.22.93.48
...
nowadays) and
fall back to older TLS 1.1 if server returns an error
.
