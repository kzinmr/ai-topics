...
**Source**: [https://www.glean.com/blog/glean-skills-launch-2026](https://www.glean.com/blog/glean-skills-launch-2026)
...
2x
AI Summary by Glean
Glean now supports the open Agent Skills standard in Glean Assistant, letting employees create and reuse personal and company skills and bring in skills from the broader ecosystem so enterprise expertise becomes a shared, standardized asset instead of staying in individuals’ heads.
Well-crafted skills significantly improve AI performance on complex, multi‑tool and domain‑specific work—especially when skills use clear routing metadata, concrete examples inside the skill, and modern reasoning models—yielding measurable gains such as higher accuracy and lower latency in Salesforce account workflows.
Skills and agents are positioned as complementary: skills encode reusable units of expertise for specific tasks, while agents orchestrate end‑to‑end workflows that decide when and how to invoke those skills, with Glean’s long‑term vision of automatically mining real work patterns into skills so organizations can scale automation without sacrificing quality or control.
...
In response, the ecosystem has converged on the open standard
Agent Skills.
Agent Skills are reusable packages of instructions, scripts, and tools that teach AI how to tackle a specific task. Instead of prompting from scratch every time, a skill captures the structure, decision points, and expertise behind a task, and pairs that knowledge with the tools needed for execution.
