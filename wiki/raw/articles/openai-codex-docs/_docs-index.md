---
title: "Codex docs site map (llms.txt)"
source_url: https://developers.openai.com/codex/llms.txt
ingested: 2026-09-26
sha256: 2ad8af441ca820fd198cbd12175d2f2c573806ec62ee2acb5b2340d96385950d
collection: openai-codex-docs
---
...
## Build Plugins
- [Build plugins](https://learn.chatgpt.com/docs/build-plugins.md): Turn a repeatable workflow into a plugin, test it, and refine it in ChatGPT.
...
## Migrate Custom Gpts
- [Moving your custom GPT workflows to plugins](https://learn.chatgpt.com/docs/migrate-custom-gpts.md): Guidance for Enterprise admins preparing their workspace and GPT creators migrating, testing, and sharing replacement plugins.

## Model Selection
- [Model selection](https://learn.chatgpt.com/docs/model-selection.md): Find the right model for your use case
