...
url: "https://hugotunius.se/2026/06/15/the-sword-juggling-fallacy.html"
fetched_at: 2026-06-16T07:00:48.955827+00:00
...
Obviously no one wants a language that’s complex, at least not more complex than the inherent complexity of the domain. Returning to the pointer example above, anytime I have to write C and deal with pointers I’m filled with dread because I know I have to consider all of these questions carefully and getting it wrong has dire consequences. By comparison Rust’s complex reference semantics, lifetimes, and borrow checker are a breeze; I know that outside of
unsafe
I’m not going to mess it up.
Sword juggling is simple, but not easy and I’d be remiss if I didn’t mention that
unsafe Rust is a bit like juggling with chainsaws
.
