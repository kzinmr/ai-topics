...
fetched_at: 2026-08-21T10:01:07.330287+00:00
source: "borretti.me"
tags: [blog, raw]
---
...
centuries, but eventually we’ll get to the
Star Trek
future where we’ve
automated all the drudgery, and all work is meaningful, heroic, and dignifies
the spirit. We will be artists, scholars, captains of the starship
Enterprise
,
etc. There’s a few problems with this idea:
“Drudgery” and “meaningful work” are in the same complexity class, so the
technology to automates the former also automates the latter.
Our revealed preference seems to be that we prefer solipsistic convenience
...
the limit are too complex, we have tried and
failed
(and
failed
and
...
and
failed
) to automate them with software. The
...
outperform humans at most economically valuable work”, as per the
OpenAI
charter
—creates an obvious discontinuity: suddenly we shoot up to 100%
automation, both of the meaningful work and the drudgery:
And at this point AGI the economic incentives
work against
humanity
. The only niche to escape to is the relational economy, where
...
alternative that gave them the same outcome or better
, without having to
...
now, too, and it’s an
exact parallel
of what happened to software engineering, only twelve
months later. The difference is that most mathematicians
hate the
de-intellectualization of their field
...
line of code, or think using formal systems at all. Why reason at all?
Our
servants will do that for us
.
What about art? Art is the
ne plus ultra
of meaning, so artists should be
...
everything I write about AI was already said by
J. D. Pressman
.
