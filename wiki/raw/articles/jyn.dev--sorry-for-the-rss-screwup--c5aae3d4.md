...
Source: https://jyn.dev/sorry-for-the-rss-screwup/
...
the reason this happened is that i added a new kind of "stub" post, and handled that correctly on the main site, but not on the rss feed. you can see the intended layout of the stub posts
here
