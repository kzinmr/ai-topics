...
fetched_at: 2026-05-05T07:01:37.235697+00:00
source: "LLVM Blog"
tags: [blog, raw]
---
...
Source: https://blog.llvm.org/posts/2022-01-12-trojan-source/
...
Trojan Source paper
encompasses a
family of attacks that rely on Unicode properties to make code
look
different
from how a compiler
processes
it. For instance the following code taken from
the paper:
#include
<stdio.h>
#include
...
looks like there is a guard on
isAdmin
...
compiler-related issue, we also agreed having a
clang-tidy
check for each
...
Are we assigining to
א
or to
ג
? We are actually doing the latter, and
that is confusing. The pass
