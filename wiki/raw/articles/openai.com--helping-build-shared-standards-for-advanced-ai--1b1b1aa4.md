...
fetched_at: "2026-06-24T07:03:45Z"
source: "web_fetch"
---
...
OpenAI already contributes across a broader ecosystem of standards and pre-standardization efforts. We participate in theInternational Organization for Standardization and International Electrotechnical Commission Joint Technical Committee 1, Subcommittee 42 on Artificial Intelligence⁠(opens in a new window)and theNational Institute of Standards and Technology-led Artificial Intelligence Consortium⁠(opens in a new window); helped found theFrontier Model Forumand the Linux Foundation’sAgentic Artificial Intelligence Foundation⁠(opens in a new window); participate in theCoalition for Secure Artificial Intelligence⁠(opens in a new window); serve on the steering committee of theCoalition for Content Provenance and Authenticity⁠(opens in a new window); and engage inInternet Engineering Task Force⁠(opens in a new window)andFast Identity Online Alliance⁠(opens in a new window)processes to advance interoperable technical standards.
...
Global AffairsJun 11, 2026

Global AffairsJun 10, 2026

Global AffairsJun 9, 2026
