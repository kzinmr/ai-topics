...
fetched_at: 2026-05-05T07:01:43.938179+00:00
source: "LLVM Blog"
tags: [blog, raw]
---
...
(FPGAs) allow reconfiguring the implemented hardware logic on the field. However, as FPGA is only an hardware design implementation technique, the "
...
TCE is based on a simple but scalable architecture template called
...
1)
Traditional "operation triggered" (first parameter is the destination)
ADD R1, R2, R3
MUL R4, R1, R5
2)
Transport triggered
...
3.
Transport triggered with software bypassing and dead result read elimination
R2 -> ADD.OPERAND, R3 -> ADD.TRIGGER
...
In case you got interested in the project or have questions to ask, please join the mailing list
tce-users@cs.tut.fi
.
