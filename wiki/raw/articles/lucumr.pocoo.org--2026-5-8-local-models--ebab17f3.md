...
fetched_at: 2026-05-09T07:01:07.900414+00:00
...
Source: https://lucumr.pocoo.org/2026/5/8/local-models/
...
any right to be.
Putting an API key into
Pi
and using a hosted model is a very
...
A dead connection is a weird connection:
local models are slow, so when
...
You won’t see what will happen:
if you are somewhat hands-on, not seeing
...
It’s just not SOTA.
We can do better, and we should aim for having the
...
To run
ds4.c
you don’t need MLX, Ollama or anything else.  It’s the whole
package.
Embedding It In Pi
Which made me build
pi-ds4
...
, compiles and starts
ds4-server
on demand, downloads and builds the runtime if needed, chooses the
...
coding agent experience.  But really, the focal point should be
ds4.c
itself
.
