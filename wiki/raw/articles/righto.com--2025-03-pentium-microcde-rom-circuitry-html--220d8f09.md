...
fetched_at: 2026-04-28T07:01:55.454830+00:00
source: "righto.com"
tags: [blog, raw]
---
...
Source: http://www.righto.com/2025/03/pentium-microcde-rom-circuitry.html
...
The Pentium has a large number of bits in its micro-instruction, 90 bits compared to 21 bits in the
8086
.
...
The presence or absence of a transistor stores a 0 or 1 bit.
1
...
The vertical metal wires form the outputs. The circles are contacts between the metal wire and the silicon of a transistor.
2
...
The MAR receives control signals and addresses from
standard-cell logic
located above the MAR.
Strangely, in Intel's published
floorplans
for the Pentium, this standard-cell logic is
...
complemented and which are not.
4
...
One of the four transistors in the multiplexer is activated (by control signal
a
,
b
,
...
The output of this multiplexer, along with the outputs of three other multiplexers, goes to the second-stage multiplexer,
5
which selects one of its four inputs, based on control signals
e
,
f
,
...
The Pentium has this testing circuitry for many ROMs and PLAs, including the division PLA that caused the infamous
FDIV bug
.
...
For more information on testing circuitry in the 386, see
...
RSS
for updates.
Peter Bosch has done some reverse engineering of the Pentium II microcode; his information is
here
.
