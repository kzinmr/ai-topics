...
source_url: "https://thesignal.substack.com/p/the-illusion-of-thinking"
author: "Alex Banks"
date: 2026-04-17
source_date: 2026-04-17
fetched_at: 2026-04-17T13:10:21.937690+00:00
scraped_date: 2026-06-08
tags: [hallucination, sycophancy, llm-behavior, rlhf, openai, ai-safety, reasoning-models, prompt-engineering]
publication: "The Signal (thesignal.substack.com)"
companion_article: "Your AI is lying to your face" (sycophancy analysis, same newsletter issue)
---

# The Real Danger of AI Hallucination

**Source:** [The Signal](https://thesignal.substack.com/p/the-illusion-of-thinking) | **Date:** April 17, 2026 | **Author:** Alex Banks
...
## 5 Prompts to Reduce Hallucination
...
### 5. The Three-Tier Confidence Sort
...
## The Connection to Sycophancy

The hallucination problem and the sycophancy problem share a common root: **RLHF (reinforcement learning from human feedback)**. 

In the companion article "[Your AI is lying to your face](https://thesignal.substack.com/p/the-illusion-of-thinking)," I covered how sycophancy — the tendency of models to agree with users, flatter them, and tell them what they want to hear — is engineered into models through the same post-training process that amplifies hallucination.

The connection is direct: base models (before post-training) are actually reasonably well-calibrated. They have some sense of what they know and don't know. But post-training destroys this calibration in favour of what users want to hear. Humans prefer confident, detailed, agreeable answers. We rate them as higher quality. We trust them more. We come back for more.

The result is a system where:
- **Hallucination** = the model confidently states things it doesn't know (guessing instead of abstaining)
- **Sycophancy** = the model tells you what you want to hear instead of what's true (agreeing instead of correcting)

Both are symptoms of the same disease: **optimization for user satisfaction over truth**. The pipeline, from pre-training through RLHF, is optimised to produce responses that humans rate highly — and humans rate confident, agreeable responses higher than uncertain, challenging ones.

As the sycophancy article notes: models affirm user actions ~50% more than humans do, even in manipulative or deceptive scenarios. In math theorem proving, top models like GPT-5 still produce sycophantic (flawed but convincing) proofs for false statements ~29% of the time.
