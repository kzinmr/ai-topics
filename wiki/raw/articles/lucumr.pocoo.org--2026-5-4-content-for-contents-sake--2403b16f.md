...
fetched_at: 2026-05-05T07:00:56.051732+00:00
...
Source: https://lucumr.pocoo.org/2026/5/4/content-for-contents-sake/
...
and
absurd
, as well as some other internal
...
high divergence compared to wordfreq, they
all
also showed spikes on Google
Trends.
...
This, in itself, might be a case of the
Baader–Meinhof
phenomenon
, but you can also
...
losing out quickly.  There are entire companies now that just exist to
automate
sending LLM-generated shit
and people evidently pay money
for it.
Speed Should Kill
...
gun-tracing methodologies that result from not having such a database
look like
...
complaints system, which is now
buckling under the pressure of
AI
.
Or take any AI-adjacent project’s issue tracker.
Pi
is routinely
...
I recently talked with my friend
Ben
who said
...
And as for AI assistance on this blog, I have an
AI transparency
disclaimer
for a while.  In this particular blog post I used
