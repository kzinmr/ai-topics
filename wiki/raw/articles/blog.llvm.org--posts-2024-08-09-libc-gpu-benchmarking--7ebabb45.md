...
fetched_at: 2026-05-05T07:01:36.766661+00:00
source: "LLVM Blog"
tags: [blog, raw]
---
...
Source: https://blog.llvm.org/posts/2024-08-09-libc-gpu-benchmarking/

GSoC 2024: GPU Libc Benchmarking
Hey everyone! My name is James and I worked on LLVM this summer through GSoC. My project is called
GPU Libc Benchmarking
. The main objective of this project was to develop microbenchmarking infrastructure for libc on the GPU.
Background
...
BENCHMARK
(LlvmLibcIsAlNumGpuBenchmark, IsAlnumCapital, BM_IsAlnumCapital);
Results
...
The existing code can be found in the
LLVM repo
.
Acknowledgements
