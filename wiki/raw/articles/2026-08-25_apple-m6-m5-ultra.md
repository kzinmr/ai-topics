...
source: apple.com/newsroom (official Apple press release)
tags: [apple, apple-silicon, m6, m5-ultra, hardware, ai-compute, on-device-ai, gpu, neural-engine]
---
...
In addition, M6 offers Apple's latest advanced graphics capabilities, including updates to the shader core architecture, Dynamic Caching, and hardware-accelerated ray tracing. M6 also has 50 percent increased geometry rates for complex graphics.
...
- M6 comparisons: preproduction Mac mini with M6 (12-core CPU, 12-core GPU, 32GB) vs 14-inch MacBook Pro with M5 (10-core CPU, 10-core GPU, 32GB) vs Mac mini with M1 (8-core CPU, 8-core GPU, 16GB).
- M5 Ultra comparisons: preproduction Mac Studio with M5 Ultra (36-core CPU, 80-core GPU, 256GB) vs Mac Studio with M3 Ultra (32-core CPU, 80-core GPU, 256GB) vs Mac Studio with M1 Ultra (20-core CPU, 64-core GPU, 64GB).
- Apple Intelligence features are currently available for testing through the Apple Beta Software Program, and will be available with macOS 27 this fall.

**HN discussion**: https://news.ycombinator.com/item?id=49410440 (1159 points, 1136 comments, Aug 25 2026)

**Related Apple Newsroom releases (same day)**:
- "Apple introduces new Mac Studio with M5 Max and M5 Ultra" (Aug 25, 2026)
- "Apple unveils a more powerful Mac mini featuring the all-new M6 and M5 Pro" (Aug 25, 2026)
