...
source_url: https://softwaredoug.com/blog/2026/04/21/metadata-the-3rd-kind-of-retrieval
...
In today's LLM world, it's never been easier classify queries + content into attributes. We can now Cheat at Search- a problem that took extensive NLP research, now can be done painlessly.

Because of how easy its become, we might be veering towards a place where we can solve a fair number of search problems with less sophistication. Even "semantic" problems. Just by having a conversation with a stakeholder.
