...
type: article
tags: [ai-investment, ai-agents, moat, private-data, evaluation, enterprise-ai]
---

# The Untrainable

**Author:** Sarah Guo (Conviction.com)
**Published:** 2026-06-10
**Source:** [saranormous.substack.com](https://saranormous.substack.com/p/the-untrainable)
...
- **The Untrainable**: Frontier work whose correctness exists only in private data, walled off from external evaluation
- **Absorption Frontier**: The expanding boundary where labs pull model scaffolding (retrieval, routing, tool use) into the weights
- **Legible vs Illegible Work**: Measurable tasks become commodities; valuable work is illegible by construction
- **Private Ground Truth**: Correctness that exists only inside an organization's data and systems
- **Permission & Accountability**: Intelligence isn't the bottleneck; being let in the door and putting your name on outcomes is

## Companies Mentioned

- **Anthropic**: Prediction markets rate as having the best model, but barely a factor in consumer chat
- **Sierra**: Charges when agent resolves customer issues; owns definition of "resolved"
- **Cognition (Devin)**: Offers performance guarantee for software outcomes
- **OpenEvidence**: Majority of American doctors use daily; settling what safe clinical answers look like
- **Harvey**: Publishes benchmark for legal AI
- **Rippling**: Matt MacInnis' company; example of private data value
- **Baseten/Fireworks**: AI-native inference providers; reliability under real traffic matters

## People Mentioned

- **Sarah Guo**: Author; Conviction.com founder
- **Noam Brown**: OpenAI reasoning models pioneer; says evaluating agents over one-year horizon requires running for a year
- **Gabe Pereyra**: Says real automation requires product, model, workflow, and firm moving together
- **Matt MacInnis**: Rippling; frames token value in terms of private vs generic reasoning
- **Mert Demirer**: MIT researcher; found coding agents increased code written by 180% but shipped by only 30%