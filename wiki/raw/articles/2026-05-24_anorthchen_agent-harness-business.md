---
title: "なぜあなたのagentプロジェクトはいつも落地が難しいのか"
date: "2026-05-24"
date_ingested: "2026-05-31"
type: x_article
source: "https://x.com/anorth_chen/status/2058554497333407927"
author: "North@CreaoAI (@anorth_chen)"
author_id: "1744746496535539712"
public_metrics:
  likes: 297
  bookmarks: 588
  retweets: 51
...
# なぜあなたのagentプロジェクトはいつも落地が難しいのか

## メタデータ

- **著者**: North (@anorth_chen) — CreaoAI Head of Community
- **公開日**: 2026-05-24
- **プラットフォーム**: X Article
- **エンゲージメント**: 297 likes, 588 bookmarks, 51 retweets, 183,707 impressions
- **元ツイート**: https://x.com/anorth_chen/status/2058554497333407927
- **記事URL**: https://x.com/i/article/2058549481314922496
...
比赛报名入口：https://community.creao.ai/campaigns/agent-trading/s1
...
この記事は[[concepts/harness-engineering]]の重要なビジネス視点を提供している：

1. **モデルとharnessの分離**: LLM=harness=Agentの3層モデルは、[[entities/john-berryman]]の「unharnessed agents」と対照的だが、同じ問題意識を共有
2. **harnessのAWS化**: AIインフラがクラウドのようにプラットフォーム化するという予測
3. **Claude Codeの成功要因**: modelよりもharnessの品質が体験を決定するという実証
4. **「モデル決定上限、harness決定兌現率」**: harness engineeringの経済的価値を簡潔に表現
