...
url: "https://borretti.me/article/on-inevitability"
fetched_at: 2026-08-31T10:07:33.304944+00:00
source: "borretti.me"
tags: [blog, raw]
---
...
, already in 1863,
observed
that machines are improving faster than humans are
...
Finally, thinking rigorously about the future
always leads to extremal
outcomes
.
Why is it false?
...
thermodynamics
. And so this lets you equivocate between the present and
...
follow.
That
is the fallacy: arguing that because something will happen
eventually
, then we might as well cut to the chase, and do it
today
. But of
...
being built
today
, and we have some control over the present.
Ok, so maybe we replace “inevitable” with “
n
-inevitable” where
n
is some
...
seed AI in a basement
” timeline, where a lone
genius who finds the right algorithm can build and run an ASI on a single-core
laptop. There are
de facto
two frontier AI companies, both in the same city,
...
paradigm. And these companies have
...
First, because those economic benefits
will not accrue to us
. ASI would grow
...
WEIRD
society is that we care about the downside far more than the
upside. Scott Alexander
explained it
very eloquently:
...
fulfill its
telos
would be more than an existential risk - it would be a
travesty.
...
and in building ASI and dying off we are fulfilling the
telos
, or purpose, of
...
futures. Borges
wrote
: the world is ordered, but it is an order of
...
Why is it bad?
Generally, if you fix the probability of something at 100%, it
distorts
...
matter that the AIs keep
escaping containment and hacking everyone
, it
doesn’t matter that their capabilities vastly exceed their wisdom: you go to war
with the army you have, analogously, you
lift to heaven
whatever
...
inevitable and extremely desirable, if it “goes right”. The
AI 2040
scenario ends with humans solving alignment and “passing the torch” to the AIs,
to run the world for our benefit. Nate Soares, for example,
writes
:
...
10
x
Dyson spheres, each hosting 10
y
hedonically-optimized mindstates, running at 10
z
subjective seconds
per second, experiencing 10
xyz
hedonic states per second, tiling
...
Sometimes they
invoke
alignment: “the AIs will be aligned, and they
...
solidly near the center of your
web of belief
, then you won’t even
