...
url: "https://nesbitt.io/2026/04/30/open-source-fantasy-draft.html"
fetched_at: 2026-05-01T07:13:04.907141+00:00
source: "nesbitt.io"
tags: [blog, raw]
---
...
Source: https://nesbitt.io/2026/04/30/open-source-fantasy-draft.html
...
Rookie class
This year’s rookie pool is the deepest on record, in the sense that there are four hundred thousand new packages and roughly nine of them were written by a person. The league has reluctantly instituted a Combine. To be draft eligible a package must demonstrate one human-authored commit, a README that does not begin with the word “Certainly”, and at least one function that cannot be replaced by a ternary.
is-even
has been grandfathered in as a Hall of Fame exhibit and is not eligible for selection, though it may be used as a tiebreaker.
...
Finally, the committee has voted to retire the number 11 across the league in honour of
left-pad
. A small ceremony will be held before the week one fixtures during which we will all run
npm install
and sit quietly until it finishes.
