...
fetched_at: 2026-05-01T07:00:51.652435+00:00
...
GitHub was not the first home of my Open Source software.
SourceForge
was
.
...
dependencies, and in particular about the problem of
micro
dependencies
.  In my mind, GitHub gave
...
comparatively small number of people.  You
knew the
names
.  You knew the mailing lists.  You knew who
...
Georg
and I ran our own
collective for our Open Source projects:
Pocoo
.  We
...
earliest Open Source projects are
technically still on
PyPI
, but the actual packages are gone.
...
licenses actually was.  GitHub even attempted to
rectify
this
with their
terms of service.
...
Pi
‘s issue tracker currently is largely a result of GitHub’s
product choices not working in the present-day world of Open Source.  It was
built for engagement, not for maintainer sanity.
It can also make the web forget again.
I quite like software that
forgets
because it has a cleansing element.
