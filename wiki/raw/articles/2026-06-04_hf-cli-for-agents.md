...
- 
		...
		Designing the hf CLI as an agent-optimized way to work with the Hub
		   ...
		   [ Hugging Face](/)       [ Models ](/models)- [ Datasets ](/datasets)- [ Spaces ](/spaces)- [ Buckets new](/storage)- [ Docs ](/docs)- [ Enterprise ](/enterprise) - [Pricing](/pricing) -     Website [ Tasks](/tasks) - [ HuggingChat](/chat) - [ Collections](/collections) - [ Languages](/languages) - [ Organizations](/organizations)  - Community [ Blog](/blog) - [ Posts](/posts) - [ Daily Papers](/papers) - [ Learn](/learn) - [ Discord](/join/discord) - [ Forum](https://discuss.huggingface.co/) - [ GitHub](https://github.com/huggingface)  - Solutions [ Team &amp; Enterprise](/enterprise) - [ Hugging Face PRO](/pro) - [ Enterprise Support](/support) - [ Inference Providers](/inference/models) - [ Inference Endpoints](/inference-endpoints) - [ Storage Buckets](/storage)    -  - [Log In](/login) - [Sign Up](/join)       [ Back to Articles](/blog) # 
	[
  ...
  Published
				June 4, 2026 [Update on GitHub](https://github.com/huggingface/blog/blob/main/hf-cli-for-agents.md) [  Upvote 13 ](/login?next=%2Fblog%2Fhf-cli-for-agents) - [](/julien-c)- [](/clem)- [](/victor)- [](/jeffboudier)- [](/davanstrien)- [](/pcuenq) - +7   [](/celinah)  [Célina Hanouti celinah   Follow ](/celinah) [](/Wauplin)  [Lucain Pouget Wauplin   Follow ](/Wauplin)    
 - [AI agent traffic on the Hub](#ai-agent-traffic-on-the-hub) - [Built for humans and agents](#built-for-humans-and-agents) [One command, multiple renderings](#one-command-multiple-renderings) - [Next-command hints](#next-command-hints) - [Non-blocking and safe to retry](#non-blocking-and-safe-to-retry) - [Discoverable, predictable commands](#discoverable-predictable-commands) - [Benchmarking the hf CLI for Coding Agents](#benchmarking-the-hf-cli-for-coding-agents) [The setup](#the-setup) - [The results](#the-results) - [Key findings](#key-findings) - [The hf-cli skill](#the-hf-cli-skill) - [Try it yourself](#try-it-yourself) - [Register an agent harness](#register-an-agent-harness) `hf` is the official command-line entrypoint to the Hugging Face Hub. Anything you can do on the Hub from the Python SDK, you can do from your terminal: download and upload models, datasets and Spaces; create and manage repos, branches, tags and pull requests; run Jobs on HF infrastructure; manage Buckets, Collections, webhooks and Inference Endpoints.
