...
# Finding your people easily with Glean enterprise search

**Source**: [https://www.glean.com/blog/finding-your-people-with-glean](https://www.glean.com/blog/finding-your-people-with-glean)
...
2x
AI Summary by Glean
Glean's enterprise search includes spell checking and fuzzy search to help users find colleagues quickly, even with typos or uncertain spellings.
The search engine is optimized to provide personalized corrections and suggestions based on the company's corpus and user access, ensuring fast and accurate results.
Glean's focus on people-seeking queries highlights the importance of finding colleagues within a company, enhancing overall workplace efficiency and collaboration.
What’s a company without its people? And what on Earth are you supposed to do if you can’t find any of them? Well we don’t know either. That’s why we’ve worked hard to build spell checking and fuzzy search to easily find your people. Believe it or not—every day, thousands of
Glean
queries are people looking for people. So we recognize how important it is for you to find people within your company. That means for us, it’s really important to be
fast
and
smart
.
...
How does it all work? If you’re looking for someone specific with Glean, look no further than our simple search bar. Built into our search engine is enterprise spell check. It’s robust to typos of all kinds, and intelligently surfaces personalized corrections for
you
as an employee of
your
company
...
You
—as in the corrections we show you are optimized based on the content you have access to.
Your company
—as in our corrections are derived from your company’s corpus. And this is done at
lightning speed
since we do a lot of the heavy lifting offline before you even start typing. When we’re talking about people and names, these are all factors of utmost importance. Piece them together and you get a perfect recipe for a spell checker that can figure out exactly who you’re looking for.
