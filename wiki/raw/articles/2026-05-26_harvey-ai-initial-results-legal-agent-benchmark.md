---
type: x_article
x_article_title: "Initial Results on Legal Agent Benchmark"
x_article_author: "Harvey AI"
x_article_url: "https://x.com/i/article/2059284537503285248"
getxapi: false
source: "X bookmarks ingestion (xurl)"
ingested: 2026-05-27
bookmark_tweet_id: "2059320727988224128"
---
...
**Intelligence is not evenly distributed**: Improvements in model capabilities are not evenly distributed across the kinds of expertise and precedent that legal work depends on. Models continue to demonstrate jagged intelligence for specialized knowledge work, with high variance across practice areas. On LAB, the leaderboard shifts substantially across legal practice areas, and no single model leads every one.
...
For production agents, single-dimensional benchmarks indexed only on quality do not capture the full complexity of deployment. In this section, we run additional evaluations that take into account cost, both monetarily and in terms of latency.
...
### Emergent Behaviors and Their Impact
...
| Behavior | All-Pass Score Impact |
|----------|----------------------|
| Conducting thorough research before drafting (>90% document coverage) | +0.4 points |
...
| Using targeted retrieval (search during the run) | +0.3 points |
| Applying structured analysis (code/shell tools for computation) | +0.3 points |
| Grounding drafts against the record (return to source documents) | +0.3 points |
...
Over time, behavioral analysis will be the tool that makes those directions interpretable to both AI researchers and lawyers. We cannot improve what we cannot interpret, and on long-horizon professional work the right unit of measurement is the trajectory as much as the final score.

LAB is going to keep growing on three fronts:

1. **The benchmark itself.** Richer task families covering more practice areas, adjacent professional-service workflows beyond legal, and longer-context matters. Partnering with Artificial Analysis to scale up LAB evaluation and publish a regularly-updated leaderboard.

2. **The research program around it.** Studying how agents handle long-horizon legal tasks, how domain knowledge transfers across legal sub-domains, and how to bake cost and latency improvements into agents alongside quality.

3. **Collaboration with AI labs and model providers.** Working with model providers whose agents were baselined to understand and inform what changes at the model layer move the needle on legal-agent performance.

## References
- Harvey AI Legal Agent Benchmark announcement: https://www.harvey.ai/blog/introducing-harveys-legal-agent-benchmark
- Harvey Labs GitHub: https://github.com/harveyai/harvey-labs
- Noam Brown tweet on agent behavior analysis: https://x.com/polynoamial/status/2047387675762802998
- OpenAI emergent tool use: https://openai.com/index/emergent-tool-use/
- DeepMind Capture the Flag: https://deepmind.google/blog/capture-the-flag-the-emergence-of-complex-cooperative-agents/
- Karpathy on jagged intelligence: https://x.com/karpathy/status/1816531576228053133
