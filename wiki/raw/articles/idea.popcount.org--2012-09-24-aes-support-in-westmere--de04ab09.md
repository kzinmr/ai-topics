---
title: "AES support in Westmere"
url: "https://idea.popcount.org/2012-09-24-aes-support-in-westmere"
fetched_at: 2026-05-05T07:01:14.325425+00:00
...
Source: https://idea.popcount.org/2012-09-24-aes-support-in-westmere
...
Intel supplies a helper instruction for that:
aeskeygenassist
.
...
# save key as the first round key
add
$
0x10
,
%rdi        # move to next slot
aeskeygenassist $0x1, %
xmm0
,
%xmm1
...
Usage
And finally, an example usage of our
ctr_stream
function:
int
main
