...
# Glean introduces Glean Agents and advances Work AI platform with the most comprehensive access to work and world knowledge

**Source**: [https://www.glean.com/blog/glean-agents-launch-blog](https://www.glean.com/blog/glean-agents-launch-blog)
...
Zillow
developed a career growth analysis agent. This agent helps employees analyze their performance evaluations and growth opportunities and outlines what they need to do to advance to the next job level
Miro
personalized sales outreach, resulting in more targeted messages and 80% less time spent on generating emails
Deutsche Telekom
rolled out an employee concierge to 80k+ employees that automates IT and HR requests using natural language
...
Universal knowledge
accesses data from both company apps and databases, as well as information from the web and LLM data, to research, analyze insights, make decisions, and automate work
Structured data analysis
enables everyone to make data-driven decisions by querying live data from structured data applications, such as Salesforce, Databricks, and Jira, using natural language
‍
Active data and AI governance
continuously scans and auto-hides overshared sensitive data across all enterprise applications, giving companies another layer of control over the data used for AI
...
Read more about Glean Agents and how to get started with creating an agent in this
blog
.
...
‍
Read more about Glean’s universal knowledge capabilities and how to integrate it into everyday workflows in this
blog
.
...
‍
Read more about Glean’s structured data analysis capabilities in this
blog
.
...
Read more about Glean’s active data and AI governance capabilities and how it deploys into the enterprise in this
blog
.
...
You can discover more about Glean Agents and our new platform capabilities, at
Glean Live: Winter ‘25 launch event
. I’ll be onstage along with Toby Roberts of Zillow, Adam Conway of Databricks, our very own Tamar Yehoshua and many more for live demos and fireside chats—I hope you’ll join us.
Back to all stories
Have questions or want a demo?
We’re here to help! Click the button below and we’ll be in touch.
Get a Demo
