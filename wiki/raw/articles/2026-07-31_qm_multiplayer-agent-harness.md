...
type: article
author: YC Software
tags: [agent, multi-agent, coding-agents, open-source]
repo_stats:
  stars: 3476
  language: TypeScript
...
- HN discussion: 584 points — https://news.ycombinator.com/item?id=49126604
- HN ObjectID: 49126604
- YC-backed open-source framework for orchestrating multiple AI agents collaboratively on real work tasks
- Works in Slack and on the web
