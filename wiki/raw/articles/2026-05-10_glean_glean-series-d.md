...
# Glean raises $200m to accelerate generative AI deployment

**Source**: [https://www.glean.com/blog/glean-series-d](https://www.glean.com/blog/glean-series-d)
...
2x
AI Summary by Glean
Glean has raised over $200M at a $2.2B valuation, with participation from major investors including Kleiner Perkins, Lightspeed Venture Partners, and Sequoia Capital, among others.
Glean's AI-powered work assistant leverages state-of-the-art search and RAG technology to provide highly personalized answers grounded in each organization's unique enterprise knowledge graph, aiming to be the go-to enterprise AI platform.
Glean has achieved significant milestones, such as launching Glean Chat and a low-code/no-code AI platform, with users saving an average of 2-3 hours per employee per week and high levels of user engagement.
...
As business leaders— particularly CIOs— find themselves under mounting pressure to quickly and securely deploy AI in their organizations, bringing responsible AI to the enterprise has become more important than ever. As revealed by a recent
survey
of CIOs, 78% of respondents believe generative AI will be critical to workplace productivity.
...
Since our $100M
series C
in 2022, we’ve achieved incredible milestones like launching
Glean Chat
and introducing our low-code/no-code centralized AI platform for companies to build
custom generative AI experiences
grounded in their company knowledge, all while witnessing industry-best levels of user engagement with our product. Glean’s
platform
will provide each and every business with the tools they need to build custom generative AI experiences grounded in their unique company knowledge. We’ve a lot further to explore, and this latest round of funding will enable us to develop the most secure, comprehensive, and intuitive enterprise AI platform of the future that empowers our users to truly elevate their workflows and productivity.
...
One sentiment that stuck with me was how much of a difference Glean makes in our users' lives. One customer noted—
"I have been rolling out software for the last 25 years, and never before have I received such amazing feedback about a product."
It’s a wonderful reminder of all the incredible work we’ve achieved over here at Glean.
...
Interested in joining us on our journey? Request a
demo
or check out our open positions on our
careers page
.
Back to all stories
Have questions or want a demo?
