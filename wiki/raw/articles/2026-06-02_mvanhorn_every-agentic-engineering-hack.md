---
type: x_article
x_article_title: "Every Agentic Engineering Hack I Know (June 2026)"
x_article_author: "mvanhorn"
date: 2026-06-02
date_ingested: 2026-06-03
getxapi: false
source_url: "https://x.com/i/article/2061440101411102721"
---
...
Three pieces:
1. A daemon that watches an AgentMail inbox over WebSocket. On every allowlisted email it opens a fresh Claude session, writes the email to a prompt file, and tells Claude to read and act on it.
2. Two terminal backends, cmux or standalone Ghostty, so it drives whatever you already launch into.
3. A sender. I wired it to a cc command in my Hermes, so from my phone I run cc <task> and it lands as a working session on my Mac, no VPN, no SSH.
...
1. **Codex IDE extension:** send a task, apply the result, never drop into the Codex terminal.
2. **/ce-work --codex:** delegates the build straight to Codex from inside the Compound Engineering loop.
3. **Printing Press Codex mode:** put codex at the end of the prompt when printing a new CLI and it hands the build to Codex.
...
Launch reels I made this way: Granola CLI demo, Agent Cookie launch.
...
- Add value on X: On X Pay $1-3/month to subscribe to people you respect. I pay $1/month to @garrytan and when I submit a PR I can send an X post to him and he gets a special notification that I'm a paying customer. I also pay for @jason @teknium @Teknium.
