...
# Hex + Snowpark Container Services: Secure Analytics and ML for Enterprises | Hex 

**Source**: [https://hex.tech/blog/hex-and-snowpark-container-services/](https://hex.tech/blog/hex-and-snowpark-container-services/)
...
We are excited to announce that Snowflake customers can now deploy Hex inside their account with
...
Note:
This is currently in limited private preview. If you would like to join the private preview,
please reach out
!
Deploy Hex entirely in Snowflake
...
twitter
linkedin
Want to learn more about how to deploy Hex within Snowflake using Snowpark Container Services? 
Sign up for the private preview ❄️
Im Interested
Learn More
Made with
🍩
