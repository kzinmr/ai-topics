...
fetched_at: 2026-04-28T07:01:51.465674+00:00
...
Source: https://michael.stapelberg.ch/posts/2025-10-31-macbook-pro-m4-impressions/
...
subjective thoughts!
Back in 2021, I wrote about the
MacBook Air
M1
, which was the first computer I used that
...
I decided to go with the MacBook Pro with M4 chip instead of the M4
Pro
chip
...
can become faster. For example, when running a Go web server on
localhost
, I
...
Best case: Page load finishes
just before
the next frame is displayed: no delay.
Worst case: Page load finishes
just after
a frame is displayed: one frame of delay.
...
Asahi Linux
still needs some work before it’s usable
