---
title: "My 2025 high-end Linux PC 🐧 (2025)"
url: "https://michael.stapelberg.ch/posts/2025-05-15-my-2025-high-end-linux-pc/"
fetched_at: 2026-04-29T07:01:14.358413+00:00
...
Source: https://michael.stapelberg.ch/posts/2025-05-15-my-2025-high-end-linux-pc/
...
Turns out
my previous attempt at this build had a faulty
CPU!
With
...
to
drive my Dell UP3218K 8K monitor
.
Components
...
Linux includes the
r8169
driver for Realtek network cards, but whether the
...
AsRock Z890 Pro-A does not seem to report the correct DIMM clock in
lshw
,
...
card reporting inaccurate values), so I double-checked with a
myStrom WiFi
Switch
and confirmed that with the Radeon
card, the PC indeed draws 20-30W more from the wall socket.
Why Low Idle Power is so important
In the comments for my
my previous blog post about the first build of this
machine not running
stable
,
...
in 2022,
when I copied my data from a Force MP600 to a WD Black
SN850
, which
...
an article about how the first build of this machine was
not stable
,
...
trouble-shooting in which I swapped out
all
the other parts of this PC, sent
...
enough.
The specific setup I used is to run
./mprime -m
, hit N (do not participate in
...
day-to-day usage. I use
suspend-to-RAM multiple times a
day
without any issues.
...
setup
. I might publish an updated version at
some point :)
Did you like this
    post?
Subscribe to this
