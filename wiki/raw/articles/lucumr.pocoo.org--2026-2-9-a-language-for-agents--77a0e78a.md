...
fetched_at: 2026-04-30T07:01:57.875434+00:00
...
test
"issue creates exp in the future"
{
using
time
=
...
large-scale automation driven by code generated on the fly (eg:
sed
,
perl
invocations).
...
Related to greppability: agents often struggle to understand
barrel
files
and they don’t
...
instance in TypeScript you can often run the code even
though it fails
type checks
.  That can gaslight the agent.  Likewise
...
No human wants to be subject to surveys, but
agents don’t
care
.  We can see how successful they are and where they
are struggling.
