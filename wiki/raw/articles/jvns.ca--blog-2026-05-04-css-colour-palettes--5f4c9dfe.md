...
Source: https://jvns.ca/blog/2026/05/04/css-colour-palettes/

Links to CSS colour palettes
May 4, 2026
A while back I decided to stop using Tailwind for new projects and to just write
vanilla CSS instead.
But one thing I missed about Tailwind was the
colour palette
(
here as CSS
).
If I wanted a light blue I could just use
blue-100
...
how to use the
oklch
CSS function to dynamically generate colors.
