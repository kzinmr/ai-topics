---
title: "Getting an LLM to Make Me a Tool for Enriching the Color Metadata in My Icon Collection"
url: "https://blog.jim-nielsen.com/2026/use-llm-to-add-color-metadata/"
fetched_at: 2026-08-24T10:32:20.095907+00:00
...
Source: https://blog.jim-nielsen.com/2026/use-llm-to-add-color-metadata/

On my
icon
gallery
sites
, I have metadata I’ve manually added over the years to tag certain icons as being predominantly
“blue”
or
“orange”
or some other color.
...
Boom, done! That all would’ve taken
so
long before. I would’ve never done it.
Takeaways:
...
.html
file that I can locate on my hard drive and open directly as a
file://
URL. No bundling. No transpilation. None of that. I don’t even need a web server! Keeping things
very
basic on this project is paying off: I had really elemental building blocks that didn’t require additional third-party tooling. Just HTML, CSS, a little in-page JS, and images on a server!
