...
source: "@trq212 / Thariq Shihipar (X Article)"
date: 2026-05-08
scraped: 2026-05-11
type: x_article
...
author_role: Member of Technical Staff, Claude Code team, Anthropic
tags:
  - prompt-engineering
  - claude-code
  - html
...
metrics:
  ...
  retweets: 1770
  quotes: 1584
  impressions: 10231412
---

# Using Claude Code: The Unreasonable Effectiveness of HTML

**Author**: Thariq Shihipar (@trq212) — Member of Technical Staff, Claude Code team, Anthropic
**Published**: 2026-05-08 on X (X Article)
**Metrics**: 14,249 likes · 28,453 bookmarks · 10.2M impressions
...
Karpathy endorsed the approach with a detailed commentary, expanding beyond HTML to a broader vision of human-AI information interfaces. He proposed a progression of output modalities: raw text → markdown → HTML → interactive neural videos/simulations — arguing that vision is the "10-lane superhighway" of information into the brain. He also highlighted input gaps (pointing, gesturing, screen sharing) that need addressing before "neuralink-esque BCIs." See [[raw/articles/2026-05-11_karpathy_html-and-vision-progression]] (3,350 likes, 3,339 bookmarks).
...
- Companion site: https://thariqs.github.io/html-effectiveness/ (20 self-contained .html files)
- Shihipar's playgrounds post: https://x.com/trq212/status/2017024445244924382
- Simon Willison's blog: [[raw/articles/2026-05-08_simonwillison_unreasonable-effectiveness-html]]
- Karpathy's response: [[raw/articles/2026-05-11_karpathy_html-and-vision-progression]]
