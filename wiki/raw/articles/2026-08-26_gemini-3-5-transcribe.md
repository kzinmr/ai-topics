...
**Authors**: Diego Melendo Casado (Senior Director, Engineering, Gemini Audio), Luke Leonhard (Chief of Staff, Gemini Audio)  
**Date**: 2026-08-26  
**Fetched**: 2026-08-27  
**Type**: model_release  
**Points**: 16 (HN)  
...
Key specifications:
- **WER**: 4.0% streaming, 2.6% non-streaming (Artificial Analysis)
- **Languages**: 85+ languages with regional accent support
- **APIs**: 
  - Real-time streaming: `gemini-3.5-transcribe-live` (Live API)
  - Pre-recorded: `gemini-3.5-transcribe` (Interactions API)
- **Features**: Smart transcription, function calling, custom vocabulary, multi-speaker identification
