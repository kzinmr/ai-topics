...
- **People/Orgs**: company, lab, open-source, anthropic, openai, google, huggingface, nvidia, langchain, pytorch, microsoft, deepseek, mistral, qwen, alibaba, xai, databricks, ibm, eleutherai, nous-research, discord, meta, sourcegraph, xiaomi, zyphra, ai-research, cloudflare, indie-maker, ycombinator, chroma, entrepreneur, researcher, pseudonymous, prime-intellect, browserbase, prefect, linear, nist, sentry, vercel, shopify
...
- **Infrastructure**: platform, protocol, security, architecture, infrastructure, hardware, aws, ray, database, isolation, nlp, networking, gpu, vram, apple-silicon, webrtc, moq, amd, email, virtualization, state-management, event-sourcing, langsmith, coinbase, mtp, hybrid-architecture, llm-proxy
