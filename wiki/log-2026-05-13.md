...
- **Reference fixes:** `[[concepts/agent-harness-comparison]]` all references → `[[comparisons/agent-harnesses]]` (entities x8, concepts x2, index.md)
- **Reference fixes:** `[[comparisons/coding-agent-harnesses]]` → `[[comparisons/agent-harnesses]]` (index.md)
