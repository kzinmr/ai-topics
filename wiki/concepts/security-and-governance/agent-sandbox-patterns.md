...
## Related Concepts
- [[concepts/security-and-governance/agent-sandboxing]] — general sandboxing technology spectrum
- [[concepts/process-supervision]] — managing long-running agent processes
- [[concepts/security-and-governance/agentic-security]] — broader security patterns
...
This is part of the broader trend where [[concepts/harness-engineering/agent-harness|agent harness]] infrastructure is being offered as a managed service rather than requiring in-house engineering, alongside [[concepts/gemini/gemini-enterprise-agent-platform|Gemini Managed Agents]] and [[concepts/security-and-governance/agent-sandbox-patterns|traditional Docker/Unikraft setups]].
