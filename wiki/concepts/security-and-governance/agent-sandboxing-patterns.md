...
## Related Concepts
- [[concepts/security-and-governance/agent-sandboxing]] — General sandboxing technologies (gVisor, Firecracker, WASM)
- [[concepts/security-and-governance/agentic-security]] — Broader agent security patterns
