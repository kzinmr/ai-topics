...
### Identity & Access
Treat agents as distinct digital identities. Enforce **least-privilege principles** — agents only access data required for specific tasks. See [[concepts/security-and-governance/agent-iam]].
