...
This enables **bot orchestration** patterns where an AI agent can spawn, configure, and manage sub-bots for specialized tasks — relevant to [[concepts/agent-swarms]] and multi-agent coordination.
...
- [[concepts/agent-swarms]] — Multi-agent coordination (bot-to-bot patterns)
