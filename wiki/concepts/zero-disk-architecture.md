...
- **[[concepts/ai-agent-memory-middleware]]**: Zero Disk is a **full separation pattern** at the L3 (cloud/shared storage) layer. Unlike S3 Files or Tigris covered by Memory Middleware, Zero Disk uses S3 directly as a backend, fully offloading agent state to the cloud.
- **[[concepts/db9-fs-sql-pattern]]**: An approach contrasting with Zero Disk's \"full separation.\" db9 **re-integrates** compute and storage within PostgreSQL, centrally managing agent file artifacts and metadata.
- **[[concepts/lambda-monolith-lambdalith]]**: A serverless deployment pattern. Highly compatible with Zero Disk's stateless compute layer.
- **[[concepts/event-driven-architecture]]**: Used alongside Zero Disk to enable asynchronous data flow.
- **[[entities/avi-im]]**: Avi Kivity, originator of this concept.
