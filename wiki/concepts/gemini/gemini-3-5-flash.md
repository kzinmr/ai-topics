...
**[[concepts/gemini/gemini-spark|Gemini Spark]]** is a 24/7 personal AI agent running on Gemini 3.5 Flash, powered by the Antigravity harness. Cloud-based — continues working even when the user closes their laptop. Deeply integrated with Workspace (Gmail, Docs, Slides). Supports:
...
- [[concepts/gemini/gemini-enterprise-agent-platform|Gemini Enterprise Agent Platform]] and Gemini Enterprise
