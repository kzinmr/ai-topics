...
MAI-Thinking-1 is a 35B active / 1T total parameter Mixture of Experts (MoE) model developed by Microsoft AI. It represents a shift toward building reasoning models from scratch using "hill-climbing" methodologies.
