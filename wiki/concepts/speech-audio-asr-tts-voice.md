...
### In OpenAI Ecosystem
- **[[concepts/gpt/gpt-realtime-api|Realtime API]]** supports multimodal (text + audio) conversations natively via WebSocket — see dedicated page for architecture, Perplexity case study, and session configuration
...
- [[concepts/gpt/gpt-realtime-api]] — OpenAI's Realtime API for native speech-to-speech agents
