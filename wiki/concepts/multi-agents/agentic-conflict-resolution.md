...
- [[concepts/multi-agents/multi-agent-orchestration-patterns]] — Orchestration styles affecting conflict patterns
- [[concepts/evaluation/evaluation-flywheel]] — Using evals to detect agent conflicts
