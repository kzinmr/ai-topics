...
> **Note:** ACP (Agent Client Protocol) is a **separate** protocol for editor-to-agent communication — see [[concepts/harness-engineering/agent-client-protocol]]. The former "Agent Communication Protocol" (IBM/I Am Bee) has **merged into A2A** under the Linux Foundation (August 2025).
...
- [[concepts/multi-agents/multi-agent-orchestration-patterns]] — How protocols enable different orchestration styles
