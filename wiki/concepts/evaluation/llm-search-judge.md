...
**LLM Search Judge** is the practice of using large language models to automatically evaluate search result relevance, replacing or supplementing expensive human labelers. It enables computation of standard IR metrics ([[concepts/evaluation/ndcg|NDCG]]) on unlabeled real-world query traffic, dramatically reducing the cost and turnaround time of relevance evaluation.
