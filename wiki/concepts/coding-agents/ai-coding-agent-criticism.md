...
- [[concepts/harness-engineering/agentic-engineering]] — The practice being debated
- [[concepts/claude-code/claude-code-source-patterns]] — Technical analysis of agent internals
