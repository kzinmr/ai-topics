...
- [[concepts/security-and-governance/agent-sandboxing]] — Relationship between process isolation and sandboxing
- [[concepts/coding-agents/closing-agent-loop]] — Loop detection and process termination conditions
