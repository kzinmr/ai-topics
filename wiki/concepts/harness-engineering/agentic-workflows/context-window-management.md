...
- [[harness-engineering/agentic-workflows/how-agents-work]] — エージェントの内部仕組み（token caching含む）
- [[subagents]] — Context Quarantineの実装パターン
- [[agentic-engineering]] — 上位概念
- [[harness-engineering/agentic-workflows/cognitive-debt]] — コンテキスト管理失敗の帰結
