...
- [[concepts/harness-engineering/agent-runtime]] — The execution environment for persistent, stateful agents
...
- [[concepts/harness-engineering/agent-engineering-guide-2026]] — "The model is stateless. The harness has to be stateful."
