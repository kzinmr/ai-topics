...
- [[harness-engineering/system-architecture/container-context]] — セキュリティ制御が適用される実行環境
- [[harness-engineering/system-architecture/agent-loop-orchestration]] — セキュアなコマンド実行
-  — セキュリティ機能を提供する基盤API
