...
- [[container-context]] — セキュリティ制御が適用される実行環境
- [[agent-loop-orchestration]] — セキュアなコマンド実行
- [[raw/articles/openai-equip-responses-api-computer-environment-2026-03-11.md]] — セキュリティ機能を提供する基盤API
