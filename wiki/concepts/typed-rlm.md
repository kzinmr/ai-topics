...
- [[concepts/context-engineering/context-folding|Context Folding]] — Parallel approach with RL training (FoldGRPO)
...
This concept extends the general [[concepts/rlm-recursive-language-models|RLM framework]], contrasts with [[concepts/context-engineering/context-folding|Context Folding]] (which adds RL training), relates to [[concepts/lambda-rlm]] as a convergent independent solution, and embodies the [[concepts/harness-engineering]] principle of constraining agent reasoning structure.
