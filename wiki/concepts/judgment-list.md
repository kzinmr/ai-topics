...
> The full normalized metric is [[concepts/ndcg]] (Normalized DCG), which divides DCG by the ideal DCG to produce a 0–1 score.
...
3. **Measure** current quality via [[concepts/ndcg]]
...
- [[concepts/ndcg]] — The normalized metric built on judgment lists
