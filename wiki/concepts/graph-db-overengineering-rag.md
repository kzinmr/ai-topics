...
### Connection to [[concepts/context-engineering/context-graph|Context Graphs]]
Context stuffing is the simplest form of giving an agent full context. The [[concepts/context-engineering/context-graph|Context Graph]] approach extends this by making decision traces searchable — but for small data, the direct approach (stuff all the data) is often enough.
