...
## コア哲学（[[concepts/openclaw/philosophy.md]]）
...
### Five-Tier Skill Precedence（[[concepts/openclaw/five-tier-precedence.md]]）
```
...
## アーキテクチャ比較（[[concepts/openclaw/architecture-comparison.md]]）
...
## Anthropic-OpenClaw Conflict（[[concepts/openclaw/anthropic-conflict.md]]）

2026年4月、Anthropicがサードパーティエージェントをサブスクリプションから排除。OpenClawインスタンスは$109.55/日（Opus）の消費に対し、一般開発者は$6/日。135,000インスタンス稼働中。

## エコシステムツール（[[concepts/openclaw/ecosystem-tools.md]]）
...
- [[harness-engineering]] — Harness Engineering（横断概念）
- [[concepts/harness-engineering/agentic-workflows/interactive-explanations.md]] — Agentic Engineering Patterns
- [[local-first-software]] — ローカルファーストソフトウェア運動
- [[personal-superintelligence]] — パーソナルスーパーインテリジェンス
- [[open-source-ai-destruction]] — オープンソースAI破壊の議論
- [[comparisons/hermes-vs-openclaw-architecture]] — 詳細アーキテクチャ比較
- [[skill-architecture-patterns]] — スキルアーキテクチャ比較分析
