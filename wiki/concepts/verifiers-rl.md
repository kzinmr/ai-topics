...
### GRPO-First Design
Verifiers focuses exclusively on [[concepts/grpo|GRPO]], the algorithm popularized by [[concepts/deepseek-r1|DeepSeek-R1]]:
...
| Aspect | Verifiers | [[concepts/fine-tuning/trl|TRL]] | [[concepts/hybrid-flow|veRL]] | NeMo-RL |
|--------|-----------|-----|------|---------|
...
- [[concepts/grpo]] — GRPO algorithm details (the only algorithm Verifiers supports)
- [[concepts/fine-tuning/trl]] — HuggingFace TRL (the library Verifiers extends)
