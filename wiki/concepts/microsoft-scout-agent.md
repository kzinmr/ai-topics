...
Microsoft Scout contrasts with [[concepts/gemini/gemini-spark|Gemini Spark]] (Google's always-on agent) — Scout emphasizes enterprise identity governance (Entra ID) and deep M365 integration, while adopting the open-source OpenClaw framework rather than building a proprietary runtime.
...
- [[concepts/gemini/gemini-spark|Gemini Spark]] — Competitive always-on agent from Google
