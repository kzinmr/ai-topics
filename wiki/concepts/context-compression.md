...
- [[concepts/harness-engineering/system-architecture/context-compaction.md]] — Context compaction in agent systems

## Sources

- [[raw/articles/crawl-2026-04-18-context-compression.md]] — Context compression techniques analysis
