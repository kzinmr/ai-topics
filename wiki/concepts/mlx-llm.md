...
[[concepts/mlx]] and [[concepts/mlx]] are Apple's MLX framework packages for running large language models and multimodal models on Apple Silicon. As of 2026, MLX provides **10–25% faster inference** than llama.cpp on Apple Silicon hardware.
...
- [[entities/claude-code]] — Local Claude Code deployment using MLX
