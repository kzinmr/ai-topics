...
- **[[entities/vicki-boykis]]** — Data scientist and blogger documenting practical local model workflows. Identified GPT-OSS as the local quality inflection point (Jun 2026).
...
| **[[entities/lm-studio]]** | Desktop GUI + local API | CPU, Metal, CUDA | OpenAI-compatible |
