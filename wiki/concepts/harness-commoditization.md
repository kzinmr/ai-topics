...
The truth likely depends on the **model capability tier**: for frontier models (GPT-5-class, Claude 4+, DeepSeek-V4), harness differences may indeed be shrinking. For weaker models, harness quality remains critical.
