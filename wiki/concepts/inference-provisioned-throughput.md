...
Provisioned Throughput is a reserved-capacity inference form factor that bridges the gap between serverless (best-effort) and dedicated (GPU-hour) inference. Introduced by [[together-ai]] in July 2026, it offers token-based pricing with a 99% uptime SLA for frontier open-weight models, without requiring users to manage serving infrastructure or negotiate GPU reservations.
...
- **Dedicated inference**: Guaranteed capacity on reserved GPU clusters, but requires capacity planning, GPU-hour math, and configuring serving stacks like [[vllm]] or SGLang.
...
The launch of Provisioned Throughput represents the maturation of the [[llm-inference]] market from "best effort" to "production SLA," positioning open-weight models as first-class citizens in enterprise AI stacks. See also: [[ai-industry-economics]] for the broader financial context driving this shift.
