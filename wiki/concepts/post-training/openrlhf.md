...
| Aspect | OpenRLHF | [[concepts/hybrid-flow\|veRL]] | [[concepts/post-training/trl\|TRL]] |
|--------|----------|------|-----|
...
- [[concepts/post-training/grpo]] — GRPO algorithm used for reasoning model training
- [[concepts/post-training/trl]] — HuggingFace TRL, the most popular RLHF library
