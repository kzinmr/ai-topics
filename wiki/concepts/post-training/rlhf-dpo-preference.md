...
- [[concepts/post-training/grpo-rl-training]] — GRPO for reasoning and format enforcement
- [[concepts/post-training/trl]] — TRL library implementing these methods
- [[concepts/harness-engineering]] — How preference optimization fits into the model + harness paradigm
- [[concepts/post-training/post-training]] — The post-training stage that encompasses preference optimization
