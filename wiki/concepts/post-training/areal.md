...
- **Newer library**: Released Feb 2025, less ecosystem maturity and community size compared to [[concepts/post-training/trl|TRL]] or [[concepts/hybrid-flow|veRL]]
...
- [[concepts/post-training/grpo]] — GRPO algorithm, one of the two algorithms AReaL supports
