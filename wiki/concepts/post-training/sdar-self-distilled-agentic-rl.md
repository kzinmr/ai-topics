...
|--------|---------|---------------|-------------------|-------------------|
| [[concepts/post-training/grpo-rl-training\|GRPO]] | None (group baseline) | N/A | RL advantage | ✓ |
| [[concepts/post-training/on-policy-distillation\|OPD]] | Separate model or same model | None | Distillation only | ✗ |
...
See [[concepts/post-training/on-policy-distillation]] for the foundational OPD work by Thinking Machines Lab (Oct 2025).
...
- [[concepts/post-training/grpo-rl-training]] — GRPO algorithm, the RL backbone
- [[concepts/post-training/on-policy-self-distillation]] — OPSD: the foundational same-model self-distillation technique SDAR builds on
- [[concepts/post-training/on-policy-distillation]] — Foundational OPD technique (Thinking Machines Lab, 2025)
...
- [[concepts/post-training/rlhf]] — Broader RLHF context
