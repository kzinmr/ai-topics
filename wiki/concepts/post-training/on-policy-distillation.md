...
[[concepts/post-training/sdar-self-distilled-agentic-rl|SDAR]] (Lu et al., 2026) adapts OPSD for multi-turn agent training by:
...
See [[concepts/post-training/on-policy-self-distillation]] for the foundational reasoning-focused OPSD.
See [[concepts/post-training/sdar-self-distilled-agentic-rl]] for the gated agent-training adaptation.
