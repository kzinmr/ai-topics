...
Flint is a declarative, JSON-based visualization DSL (domain-specific language) created by Microsoft Research, designed specifically for AI agents to generate and describe charts. It compiles to Apache ECharts for rendering and integrates with the [[concepts/mcp]] (Model Context Protocol) ecosystem via a dedicated MCP server.

## Overview

- **Creator**: [[entities/microsoft]] Research
...
- **Data exploration**: Interactive data visualization as a [[concepts/advanced-tool-use|tool-use]] primitive in agent workflows
