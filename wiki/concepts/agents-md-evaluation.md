...
related: [[concepts/claude-md-rules]], [[concepts/context-engineering]], [[concepts/agent-skills]], [[entities/andrej-karpathy]]
---
...
[agents-md-evaluation] ──relates-to──→ [[concepts/context-engineering]]
[agents-md-evaluation] ──relates-to──→ [[concepts/agent-skills]]
[agents-md-evaluation] ──embodies──→ [[concepts/context-engineering]]
```
