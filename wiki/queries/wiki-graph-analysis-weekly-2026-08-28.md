...
**Date**: 2026-08-28 15:02 UTC

## Summary

| Metric | Value |
|--------|-------|
| Total pages scanned | 3021 |
| Entities | 916 |
| Concepts | 2038 |
| Comparisons | 35 |
| Queries | 4 |
| Events | 28 |
| Orphans (no inbound links) | 478 |
| Content-rich orphans | 475 |
| Broken wikilinks | 3555 |
| Fixable wikilinks | 197 |
| Duplicate groups | 16 |
| Oversized pages (>200 lines) | 313 |
| Missing sources | 0 (0%) |
| Tag violations | 1099 |
| Stale pages (>90 days) | 1725 |
| Skeleton pages | 0 |
| Not indexed in index.md | 27 |
| Stale index entries | 7 |

## 1. Orphan Pages

478 pages have zero inbound links from other wiki pages.
...
3555 total broken links.

| Issue Type | Count | Description |
|------------|-------|-------------|
| bare-wikilink-missing | 1840 | Bare name, target page does not exist |
| missing | 1518 | Namespaced link to a page that does not exist |
| bare-wikilink | 109 | Bare name without namespace prefix (auto-fixable) |
| cross-namespace | 88 | Entity ↔ concept namespace mismatch (auto-fixable) |
...
- `entities/alloomi-ai`: [[context-engineering]] → [[concepts/context-engineering]]
- `entities/alloomi-ai`: [[opencontext]] → [[entities/opencontext]]
- `entities/bill-gates`: [[gary-marcus]] → [[entities/gary-marcus]]
- `entities/bill-gates`: [[ai-employment-displacement]] → [[concepts/ai-employment-displacement]]
- `entities/bill-gates`: [[gary-marcus]] → [[entities/gary-marcus]]
- `entities/bill-gates`: [[forward-deployed-engineering]] → [[concepts/forward-deployed-engineering]]
- ... and 187 more
...
- **27 pages** are on disk but not listed in index.md
...
313 pages exceed the 200-line threshold.

- **concepts/agentic-search** — 1191 lines
- **entities/harvey** — 958 lines
- **entities/simon-willison** — 932 lines
- **entities/ed-zitron** — 887 lines
- **entities/anthropic** — 831 lines
- **concepts/rlm-recursive-language-models** — 742 lines
- **entities/fireworks-ai** — 740 lines
- **concepts/dspy-rlm** — 698 lines
- **entities/openai** — 640 lines
- **entities/claude-code** — 629 lines
- ... and 303 more

## 6. Stale Pages (>90 days since update)

1725 pages have not been updated in over 90 days.

## 7. Tag Violations

1099 pages use non-canonical tags.

## 8. Recommended Actions

- [MEDIUM] Fix 197 cross-namespace / bare wikilinks
- [MEDIUM] Add inbound links to 475 content-rich orphan pages
- [HIGH] Review and consolidate 16 potential duplicate groups
- [LOW] Consider splitting 313 oversized pages (>200 lines)
- [HIGH] Fix 1099 pages with non-canonical tags
- [MEDIUM] Remove 7 stale index entries (files missing)
- [LOW] 1725 pages stale >90 days - review needed
