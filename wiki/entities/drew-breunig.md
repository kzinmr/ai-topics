...
Breunig's career spans advertising, location intelligence, geospatial data, and AI. He co-founded **Reporter** (2014), an award-winning quantified-self app with Nicholas Felton, and built **StepList** (2024), a routine management application. His 2024–2025 writings on context engineering positioned him as a key thinker in LLM application architecture. His blog at dbreunig.com, active since 2010, covers AI, geospatial technology, media, culture, and software development with a distinctive voice blending anthropological insight with technical depth.
...
- **DSPy for LLM applications**: He champions [[concepts/dspy|DSPy]]'s philosophy of decoupling tasks from specific models and prompts.
...
- [[concepts/placeiq]] — Location intelligence company where Breunig worked
