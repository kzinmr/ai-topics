...
- **"What if you don't need MCP at all?"** (November 2, 2025) — Critique of the [[concepts/mcp]] hype. Argues that simple tool-call patterns are often sufficient and that MCP adds unnecessary complexity for many use cases.
...
- **[[entities/will-mcgugan]]** — Both build terminal-based tools for developer productivity; McGugan's Rich/Textual/Toad and Zechner's pi-tui represent different approaches to the same problem space
- **[[entities/bryan-bischof]]** — Both skeptical of AI hype; Bischof's R.I.P. grep and Zechner's AMS replica critique represent complementary approaches to cutting through marketing claims
