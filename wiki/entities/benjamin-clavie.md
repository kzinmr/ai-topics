...
- **[[jeremy-howard]]** — Answer.AI共同創設者。Claviéが2024年に参加。fast.ai哲学の影響を強く受ける
- **[[omar-khattab]]** — ColBERT/DSPy発明者（Stanford）。ClaviéのColBERT研究の直接的インスピレーション
- **[[benjamin-warner]]** — ModernBERT共同リード、fastkmeans共著者
- **[[antoine-chaffin]]** — ModernBERT共同リード、PyLate開発者
- **[[makoto-kato]]** — ClaviéのPhD指導教員（NII Tokyo/Kasys lab）
- **[[griffin-adams]]** — ColBERT token pooling共著者
- **[[rikiya-takehi]]** — mxbai-edge-colbert-v0主著者（Waseda Univ/Mixedbread intern）
- **[[xianming-li]]** — Mixedbread/Wholembed v3共著者、ECIR 2026 LIR Workshop co-organizer
- **[[tom-aarsen]]** — Hugging Face、PyLateコントリビューター、ECIR 2026 LIR Workshop co-organizer

## Related Concepts

[[colbert]], [[ragatouille]], [[modernbert]], [[information-retrieval]], [[late-interaction]], [[token-pooling]], [[synthetic-data]], [[embeddings]], [[raw/articles/crawl-2026-04-21-agentic-alternative-graphrag.md]], [[jacolbert]], [[mxbai-embed]]
