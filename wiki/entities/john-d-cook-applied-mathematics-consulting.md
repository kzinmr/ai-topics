...
- [Gaussian distributed weights for LLMs: NF4 and QLoRA](https://www.johndcook.com/blog/2026/04/18/qlora/) (Apr 2026) — NF4量子化形式はなぜFP4よりLLM's 重み分布に適しているかを数学的に分析. QLoRA's 非対称量子化がなぜ正確に0を表現できないか, bitsandbytes's α=929/960という設定's 由来等问题を追究. 
