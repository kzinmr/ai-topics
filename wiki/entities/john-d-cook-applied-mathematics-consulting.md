...
- [[entities/hillel-wayne]] — Formal methods practitioner and educator, shared interest in practical software verification
-  — The correctness conundrum in AI systems-  — HIPAA expert determination and differential privacy
...
- [Gaussian distributed weights for LLMs: NF4 and QLoRA](https://www.johndcook.com/blog/2026/04/18/qlora/) (Apr 2026) — Mathematically analyzes why the NF4 quantization format is better suited to LLM weight distributions than FP4. Investigates why QLoRA's asymmetric quantization cannot accurately represent zero, and the origin of bitsandbytes' α=929/960 setting, among other questions.
