...
**Rakhim Davletkaliyev** is a staff engineer at [[concepts/iqm-quantum-computers]], a programming educator, author, and philosophical tech writer. He blogs at [[concepts/rakhim.exotext.com]] (with a web log at blog.rakhim.org), where he writes about the intersection of programming, computing theory, and the human experience of building software.
...
| 2024–2025 | Publishes *Quantum Computing For Software Engineers* (Leanpub); joins [[concepts/iqm-quantum-computers]] as staff engineer |
...
His bookshelf entries reveal his intellectual influences: [[concepts/sicp]] (Structure and Interpretation of Computer Programs), [[concepts/how-to-design-programs]], [[concepts/clojure-for-the-brave-and-true]], Sean Carroll's physics books, and Victor Papanek's design theory. He reads widely across programming, physics, psychology, and philosophy — and integrates these perspectives into his technical writing.
...
[[concepts/iqm-quantum-computers]] — Rakhim's employer; Finnish quantum computing company
[[concepts/clojure]] — Functional programming language; Rakhim published *Foundations of Clojure*
[[concepts/emacs]] — Rakhim built Castlemacs (minimalist Emacs for macOS)
Genetic Programming — Rakhim's flatMap 2019 talk topic
[[concepts/lisp]] — Language family central to Rakhim's evolutionary computing research
[[concepts/go-golang]] — Language used for Underblog static site generator
[[concepts/python]] — Primary language for quantum computing work and PyCon talks
