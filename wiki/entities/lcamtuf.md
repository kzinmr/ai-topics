...
Zalewski followed this with "AI Children's Books, Body Horror Edition" (June 2026), where he purchased an actual Amazon bestseller AI-generated children's encyclopedia to test the output quality directly. The illustrations — generated by a frontier model from a major US lab — were described as genuine body horror: anthropomorphic animals with fused limbs, reaching reflections, and unsettling landscapes. He identified three economic drivers for the AI children's book market: (1) high volume (most children receive an encyclopedia), (2) buyer-reader separation (purchased as gifts), and (3) ability to undercut traditional publishers without IP infringement risk. The deeper point extends his original argument: even if future technical models fix generation quality, the market structure rewards volume over accuracy, creating perverse incentives that quality improvements alone cannot address.
...
- **AI children's book quality analysis**: Analysis of body-horror-quality AI-generated children's book illustrations and market structure incentives
...
- lcamtuf.substack.com--p-ai-childrens-books-body-horror-edition--82885d9e
