...
- [[concepts/context-engineering/context-lock-in|Context Lock-in]] — The competitive risk Sentra solves: enterprises that outsource context to model vendors face irreversible lock-in. Sentra provides the neutral, owned context layer. [[entities/ashwingop]]'s thesis: "Rent the Intelligence. Own the Context."
