...
Her intellectual identity is shaped by two core traits she has named herself: **persistence** and **humility** — the latter stemming from childhood mathematics competitions where she learned that raw talent disparities require doubled effort, and the former driving her to tackle problems many considered impossible (like training a robot hand to solve a Rubik's Cube purely in simulation).
