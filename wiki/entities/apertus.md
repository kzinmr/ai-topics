...
**Apertus** is the organization and project behind the [[concepts/apertus|Apertus open foundation model]] for [[concepts/sovereign-ai|sovereign AI]]. The project's tagline — "Apertus is to AI as Open is to Source" — reflects its mission to provide fully open, reproducible, and auditable AI infrastructure as a global public good.
...
- [[entities/mistral-ai]] — European AI champion with open-weight models
