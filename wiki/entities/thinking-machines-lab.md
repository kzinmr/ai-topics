...
Tinker is a fine-tuning API that lets users submit fine-tuning jobs for open-weight models, run on Thinking Machines' internal training infrastructure. The company emphasizes open science, planning to regularly publish research notes, papers, and code.
