...
Human experts design courses and curricula, but AI teaching assistants scale personalized guidance to every student. The goal is to make it possible for anyone to learn from the best minds in their field.
...
*"The biggest bottleneck in AI isn't compute or data. It's understanding."* Karpathy believes that demystifying AI through education is the most important work for long-term progress.

### Minimalism in Education
His progression from micrograd → makemore → nanoGPT → microgpt shows a commitment to **reducing AI concepts to their absolute minimum**. If you can understand it in 200 lines of Python, you understand it.
...
Future coding will resemble resource management games — setting up systems, defining goals, and watching agents execute — rather than typing individual statements.

### AGI Timeline: ~10 Years
Predicts steady, incremental diffusion of AI capabilities, not a sudden explosion. Key bottlenecks: continual learning/memory, synthetic data collapse, RL inefficiency. Advocates for the **"march of nines"** — measuring progress in reliability (99.9%, 99.99%) rather than benchmark leaderboard scores.

### Critique of Current Reinforcement Learning
Calls current RL *"terrible"* due to reward hacking and extreme sample inefficiency. Views RLHF as *"barely RL"* — more of a targeted finetuning approach. Prefers imitation learning + targeted finetuning over pure RL approaches.

### Adversarial Examples Are Fundamental
Adversarial attacks are **not a deep learning bug** — they're a fundamental property of high-dimensional spaces. Even simple linear classifiers are vulnerable. Robustness requires architectural changes, not just better training.

### Human vs. Machine Performance Is Narrower Than Assumed
From CIFAR-10 and ImageNet manual classification studies: human accuracy ~94%, machine accuracy approaching the same. *"Humans are actually quite good at image classification — but we're slow and expensive."*

### Measurement Changes Behavior
From "Quantifying Productivity" (2014): *measurement itself changes behavior*. What gets measured gets managed — but the act of measurement creates feedback loops. Broader implication: AI evaluation benchmarks create incentives that may distort research directions.

### Creative AI Philosophy
From his short stories ("Forward Pass", "A Cognitive Discontinuity"): explores what it "feels like" to be a neural network. The gap between current AI and true AGI is not just technical but **phenomenological**. One of the few major AI researchers who writes creative fiction about AI.
