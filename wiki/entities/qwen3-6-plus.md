...
Qwen3.6-27B is the dense (non-MoE) counterpart in the Qwen3.6 family. While the 35B-A3B MoE excels at specific benchmarks (Pelican SVG), the 27B dense model outperforms the 397B MoE flagship on coding benchmarks: [[qwen3-6-27b]].
