...
Yeachan Heo (@bellman_ych) is a developer and algorithmic trader based in Seoul, South Korea. Known for creating the **OmX ecosystem** — workflow and orchestration layers for AI coding agents. He is a primary collaborator on the **[[concepts/coding-agents/claw-code]]** project and serves as a key maintainer of its Rust implementation.
