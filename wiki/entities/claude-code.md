...
AnthropicのAIコーディングエージェント。CLI、デスクトップアプリ、VS Code/JetBrains拡張、Web、iOS、Slackマルチサーフェスで動作。[[entities/boris-cherny]]によって開発され、2025年7月に[[entities/anthropic]]から[[entities/openai]]へ移管された。
...
- [[entities/anthropic]] — Original developer
- [[entities/openai]] — Current owner (since Jul 2025)
