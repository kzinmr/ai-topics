...
> "Human annotators rarely exceed 90% accuracy (Kappa often 0.2-0.3, miss ~50% of defects due to fatigue). The true benefit [of LLM evaluators] isn't higher accuracy than humans—it's scalability."
