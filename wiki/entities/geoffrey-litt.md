...
- **[[entities/simon-willison]]** — Fellow thinker on AI tooling and practical applications; both explore how LLMs can augment existing workflows rather than replace them.
- **[[entities/hamel-husain]]** — Both advocate for transparent, hackable AI tools over black-box platforms; share interest in practical developer tooling.
